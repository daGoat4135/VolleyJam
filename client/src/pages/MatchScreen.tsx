          ...
          <div className="score-display">
            <div className="text-center mb-2">
              <Input
                ...
                className="font-digital text-8xl text-center text-[#FF4D4D] w-full max-w-[300px] mx-auto"
              />
            </div>
          </div>
        </div>
          ...
          <div className="score-display">
            <div className="text-center mb-2">
              <Input
                ...
                className="font-digital text-8xl text-center text-[#4169E1] w-full max-w-[300px] mx-auto"
              />
            </div>
          </div>
        </div>
